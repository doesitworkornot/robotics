...
{
  new (message_memory) full_name::msg::FullNameMessage(_init);
}

void FullNameMessage_fini_function(void * message_memory)
{
  auto typed_message = static_cast<full_name::msg::FullNameMessage *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember FullNameMessage_message_member_array[3] = {
  {
    ...
    offsetof(full_name::msg::FullNameMessage, last_name),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(full_name::msg::FullNameMessage, name),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(full_name::msg::FullNameMessage, first_name),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers FullNameMessage_message_members = {
  "full_name::msg",  // message namespace
  "FullNameMessage",  // message name
  3,  // number of fields
  sizeof(full_name::msg::FullNameMessage),
...
get_message_type_support_handle<full_name::msg::FullNameMessage>()
{
  return &::full_name::msg::rosidl_typesupport_introspection_cpp::FullNameMessage_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, full_name, msg, FullNameMessage)() {
  return &::full_name::msg::rosidl_typesupport_introspection_cpp::FullNameMessage_message_type_support_handle;
}
